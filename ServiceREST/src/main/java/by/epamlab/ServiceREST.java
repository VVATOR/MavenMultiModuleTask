...
public interface ServiceREST {
    ...
    @WebMethod
    Response getDocument(@PathParam("id") int id) throws ElementNotFoundException;
    ...
    @WebMethod
    Response documentCreate(Document document);
