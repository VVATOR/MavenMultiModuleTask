...
public class DocumentStore implements IDaoCRUID<Document> {
    ...
    @Override
    public int create(final Document element) {
    ...
    @Override
    public Document getById(final int id) throws ElementNotFoundException {
    ...
    @Override
    public Document update(final Document element) throws ElementNotFoundException {
